    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start your farmers market readiness journey</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-center text-sm text-gray-500 mt-4 leading-relaxed">
            By creating an account you agree to our terms of service. This tool helps you prepare — not legal advice.
          </p>
